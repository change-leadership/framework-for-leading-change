...
The framework is divided into four parts (inspired by the upstream, midstream, downstream model often used to [https://www.rand.org/content/dam/rand/pubs/working_papers/WR1000/WR1096/RAND_WR1096.pdf identify the social determinants of health]).


-----

<span id="using-the-framework"></span>
== '''Using the framework''' ==
...
[[File:FLC-Deepening.png]]

'''1.''' [https://articles.alpha.canada.ca/framework-for-leading-change/?page_id=116 Navigating the world of change] provides us with essential concepts that will help us to develop our strategy and implement our plan.

'''2.''' [https://articles.alpha.canada.ca/framework-for-leading-change/?page_id=201 Laying our foundation for successful change] covers the “why” of the change, the conditions that need to be fulfilled for us to succeed, and some of the ways we can bring it about. In this phase we set the stage for the strategy we will use to navigate our change.

<span id="how-can-this-section-help-us"></span>
...
'''3.''' [https://articles.alpha.canada.ca/framework-for-leading-change/?page_id=255 Understanding our context] involves assessing our environment and culture, both to see where our change fits within the broader organization, and so we can determine the best approach to support it.

'''4.''' [https://articles.alpha.canada.ca/framework-for-leading-change/?page_id=282 Capacity, readiness and impact] provides an opportunity for us to refine our understanding of how ready we are for change, the impact it will have on key players, and how we will work with them throughout the change.

'''5.''' [https://articles.alpha.canada.ca/framework-for-leading-change/?page_id=322 Getting people on board] includes the engagement activities necessary to ensure the change is successful, depending on the type of change we are leading and who is taking part in it.

'''6.''' [https://articles.alpha.canada.ca/framework-for-leading-change/?page_id=347 Developing our plans] involves creating and integrating the various plans (e.g., engagement, communications) that will guide us when rolling out the change.

<span id="how-can-this-section-help-us-1"></span>
=== How can this section help us? ===
...
[[File:FLC-Navigating.png]]

'''7.''' [https://articles.alpha.canada.ca/framework-for-leading-change/?page_id=386 Implementing the change] involves carrying out the activities developed in the first sections, including being flexible, soliciting feedback, and adapting as we go.

<span id="how-can-this-section-help-us-2"></span>
=== How can this section help us? ===
...
[[File:FLC-Waypoint.png]]

'''8.''' [https://articles.alpha.canada.ca/framework-for-leading-change/?page_id=412 Living with the change] is about ensuring the change is sustainable and that we can continue to build on our successful outcome, which will help strengthen the organization in facing future change.

<span id="how-can-this-section-help-us-3"></span>
=== How can this section help us? ===
...
[https://articles.alpha.canada.ca/framework-for-leading-change/home/where-should-we-start/ Where should we start in the Framework?]

[https://articles.alpha.canada.ca/framework-for-leading-change/navigating-the-world-of-change/ Get started]
