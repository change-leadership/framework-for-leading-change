...
nav:after {
    ...
    <nav class="navbar">
        <ul class="nav-list">
        <img src="https://intranet.tpsgc-pwgsc.gc.ca/boew-wet/wet4.0/GCWeb/assets/wmms-spl.svg" alt="Government of Canada / gouvernement du canada" border="10px; solid; black" padding-right="2px">
